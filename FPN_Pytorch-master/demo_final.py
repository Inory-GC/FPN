...
if __name__ == '__main__':
    ...
    input_dir = args.load_dir + "/" + args.net + "/" + args.dataset + "/exp_name"
    ...
    while (num_images >= 0):
        ...
        for j in xrange(1, len(pascal_classes)):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    im2show = vis_detections(im2show, pascal_classes[j], cls_dets.cpu().numpy(), im_file, 0.7)
                #    im2show = vis_detections(im2show, pascal_classes[j], cls_dets.cpu().numpy(), 0.7)  #修改
        misc_toc = time.time()
        ...
        if vis and webcam_num == -1:
            ...
            result_path = os.path.join("images_det/", imglist[num_images][:-4] + "_det.jpg")
