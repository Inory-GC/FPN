...
#__C.TRAIN.SCALES = (600,)   #修改
__C.TRAIN.SCALES = (1500,)

# Max pixel size of the longest side of a scaled input image
#__C.TRAIN.MAX_SIZE = 1000   #修改
__C.TRAIN.MAX_SIZE = 8000
...
# The scale is the pixel size of an image's shortest side
#__C.TEST.SCALES = (600,)
__C.TEST.SCALES = (1100,)  #修改

# Max pixel size of the longest side of a scaled input image
#__C.TEST.MAX_SIZE = 1000
__C.TEST.MAX_SIZE = 8000   #修改
...
__C.TEST.RPN_POST_NMS_TOP_N = 2000  #修改  
# Proposal height and width both need to be greater than RPN_MIN_SIZE (at orig image scale)
#__C.TEST.RPN_MIN_SIZE = 16
__C.TEST.RPN_MIN_SIZE = 8  #修改  
...
def cfg_from_file(filename):
  ...
  with open(filename, 'r') as f:
    yaml_cfg = edict(yaml.load(f,Loader=yaml.FullLoader))  #修改
