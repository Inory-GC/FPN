...
def vis_detections(im, class_name, dets ,imfile,thresh=0.8):
    """Visual debugging of detections."""
    boxList = []
    # for i in range(np.minimum(10, dets.shape[0])):
 #   for i in range(np.minimum(50, dets.shape[0])):
    for i in range(np.minimum(800, dets.shape[0])):
        ...
        if score > thresh:
          ...
          #  print(bbox[0], bbox[1], bbox[2], bbox[3])
            box = [bbox[0], bbox[1], bbox[2], bbox[3], 'Vehicle', '\n']
            boxList = boxList + box

        Txt_filename = '/home/ai/FPN_Pytorch-master/BoxPoint/' + str(imfile).split('/')[1].split('.')[
            0] + '.txt'
        print(Txt_filename)
...
#    num_dets = np.minimum(10, dets.shape[0])
    num_dets = np.minimum(800, dets.shape[0]) #修改
